          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '60px', alignItems: 'center' }}>
            ...
            <div className="reveal">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', color: 'var(--text-mid)', fontSize: '1rem', lineHeight: 1.8 }}>
                <p>
                  אברהם דסה הוא יועץ פיננסי מורשה בעל ניסיון רב בתחום הייעוץ הפנסיוני, הביטוחי והפיננסי. הוא מתמחה בסיוע לאנשים ולמשפחות לנהל את עתידם הפיננסי בחכמה, אחריות ושקיפות מלאה.
                </p>
                <p>
