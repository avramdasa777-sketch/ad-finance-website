...
const areas = [
  {
    Icon: CoinsIcon,
    title: 'דמי ניהול',
    desc: 'חשיפת דמי הניהול שאתם משלמים — מצבורית ומפרמיה — ומשא ומתן להורדתם מול קרנות הפנסיה.',
    color: '#1a3a5c',
  },
  {
    Icon: ChartBarIcon,
  ...
  },
  {
    Icon: TrendingUpIcon,
    title: 'תשואות',
    desc: 'בדיקת ביצועי הקופות לאורך זמן מול הממוצע בשוק — ומעבר לקרן ביצועית יותר אם צריך.',
    color: '#0d1f3c',
  },
  {
    Icon: ClockIcon,
...
const checklistItems = [
  ...
  'ניתוח דמי הניהול מצבורית ומפרמיה — ומשא ומתן להורדתם',
    ...
    <>
      ...
      <section style={{ padding: '80px 24px', background: 'var(--cream)' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          ...
          >
            {areas.map(({ Icon, title, desc, color }) => (
          ...
          >
            ...
            <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: '10px' }}>
              {[
                'שכירים שלא בדקו את הפנסיה שלהם מעולם — או שלא בדקו בשנים האחרונות',
