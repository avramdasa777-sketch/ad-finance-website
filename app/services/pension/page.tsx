...
const areas = [
  {
    Icon: CoinsIcon,
    title: 'דמי ניהול',
    desc: 'בדיקת דמי הניהול שאתם משלמים — ביחס לצבירה ולהפקדה שלכם במוצרים הקיימים — ובחינת אפשרויות לשיפורם והוזלתם מול הגופים המנהלים.',
    color: '#1a3a5c',
  },
  {
    Icon: ChartBarIcon,
  ...
  },
  {
    Icon: ClockIcon,
    title: 'תכנון פרישה',
    desc: 'חישוב הפנסיה הצפויה בגיל פרישה, בניית תוכנית שתבטיח רמת חיים נאותה, וקיבוע זכויות לתשלום מס מופחת.',
    color: '#1a3a5c',
  },
];
...
const checklistItems = [
  ...
  'קיבוע זכויות בעת הפרישה — תכנון נכון של אופן משיכת הכספים כדי למקסם את הטבות המס ולשלם כמה שפחות מס',
];
